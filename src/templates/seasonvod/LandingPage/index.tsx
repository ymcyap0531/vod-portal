...
const EraLandingPageTemplate = ({
  ...
  const specialCategoriesList = ["SeasonVOD Trending", "SeasonVOD Picks"];
  return (
          ...
          <div className="flex ">
            <div className={`${styles.home_img} home_img sm:flex-[none] md:flex-[1_0_0%] `}>
              <Image
                height={949}
                width={600}
                src={`${process.env.NEXT_PUBLIC_CONTENT_IMAGE_URL}img/${brand.attributes.template}/home_img9.png`}
              ...
              <div className="slogan">
                <div className={`${styles.sloganimg} sloganimg slogan-img`}>
                  <Image
                    width={500}
                    height={338}
                    src={`${process.env.NEXT_PUBLIC_CONTENT_IMAGE_URL}img/${brand.attributes.template}/home_skin9.png`}
                    // src="/seasonvod/img/home_skin9.png"
                    alt="home_skin9"
                  />
                </div>
                <h1>
        ...
        <div className="container">
          <div className={`${styles.movierow} movierow`}>
            {specialCategories.data.map((special_category: SpecialCategory) => {
              if (special_category.attributes.name === "SeasonVOD Top") {
                return (
                  <>
      ...
      >
        <div className="container">
          <div className="sm:flex">
            <div className="sm:w-6/12 order-md-first md:text-left">
            ...
            <div className="sm:w-6/12 order-md-last">
              <Image
                height={800}
                width={622}
                src={`${process.env.NEXT_PUBLIC_CONTENT_IMAGE_URL}img/${brand.attributes.template}/multidevice9.png`}
                // src="/seasonvod/img/multidevice9.png"
