...
const EraSignUpTemplate: React.FC<TemplateProps> = ({
  subscription,
  handleClick,
  trial,
  membership,
  ...
  return (
    <div className={styles.SignUpForm}>
      ...
      <section
        className={`${styles.home} signup ${styles.pos_re}`}
        ...
        <div className="container">
          <div className="flex ">
            ...
            <div className="flex-[1_0_0%]">
              <h2>{translatedText.sign_up_title}</h2>
              <br />
              ...
              <label className="radioblock">
                ...
                <div className="textchoice font-bold">{brand.attributes.trial.signupTitle}</div>
              </label>
              <div className="pl-8 text-[#000000] text-xs">{brand.attributes.trial.signupDescription}</div>
              <label className="radioblock">
                <input
                  type="radio"
                  name="Buy Directly"
                ...
                />
                <span className="checkmark-radio" />
                <div className="textchoice font-bold">{brand.attributes.membership.signupTitle}</div>
              </label>
              <div className="pl-8 text-[#000000] text-xs">{brand.attributes.membership.signupDescription}</div>
              ...
              <>
                <label className="radioblock">
                  ...
                  />
                  <span className="checkmark-radio" />
                  <div className="textchoice font-bold">{brand.attributes.fallback.signupTitle}</div>
                </label>
                <div className="pl-8 text-[#000000] text-xs">{brand.attributes.fallback.signupDescription}</div>
              </>
              )}
              <br />
...
export default EraSignUpTemplate;
