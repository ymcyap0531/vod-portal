  ...
  if (catResError || movieError) {
    ...
    return (
      <div className={styles.watch_classics_vod}>
        ...
        <section className={`products ${portalstyles.pos_re}`} id="">
          ...
          <div className="justify-center flex container">
            <div className="grid grid-cols-5 gap-1 sm:gap-4">
              ...
              >
                <button
                  disabled={metaPage <= 1}
                  className={`${portalstyles.bg_primary_color} rounded p-0.5`}
                >
        ...
        <section
          className={`${styles.copyright} ${portalstyles.pos_re}`}
          id="sec4"
        >
          <Footer brand={brand} />
        </section>
...
export default ClassicsPortaLTemplate;
