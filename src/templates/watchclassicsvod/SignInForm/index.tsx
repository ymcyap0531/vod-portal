...
const EraSignInProps = ({
  ...
  return (
    <div className={styles.watch_classics_vod}>
      ...
      />
      <section
        className={`${styles.home} home signin ${signInFormstyles.pos_re}`}
          ...
          <div className="flex">
            ...
            <div className="flex-[1_0_0%]">
              ...
              <form className="form" id="contact-form">
                ...
                <br />
                <br />
                <div className={signInFormstyles.sign_instead}>
                  <p>
      ...
      <section
        className={`${styles.copyright} ${signInFormstyles.pos_re}`}
        id="sec4"
      >
        <Footer brand={brand} />
      </section>
