...
import genresstyles from "../styles/Genres.module.css";
import Footer from "../../../components/Footer";
import { TemplateProps } from "../../../pages/Genres/types";

const ClassicsGenresTemplate = ({ brand, categories }: TemplateProps) => {
  return (
    <div className={styles.watch_classics_vod}>
      <PortalNavBar styles={styles} brand={brand} />

      <section className={`products genres ${genresstyles.pos_re}`} id="">
      ...
      <section
        className={`${styles.copyright} ${genresstyles.pos_re}`}
        id="sec4"
      >
        <Footer brand={brand} />
      </section>
...
export default ClassicsGenresTemplate;
