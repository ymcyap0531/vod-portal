...
const EraLandingPageTemplate = ({
  ...
  const specialCategoriesList = ["Timeless Fave", "Timeless Gems"];
  return (
    <div className={styles.landing_page}>
          ...
          <div className="flex ">
              ...
              <div className="slogan">
                <div className={`${styles.sloganimg} sloganimg slogan-img`}>
                  <Image
                    width={500}
                    height={338}
                    src={`${process.env.NEXT_PUBLIC_CONTENT_IMAGE_URL}img/${brand.attributes.template}/home_skin7.png`}
                    // src="/timelessvod/img/home_skin7.png"
                    alt="home_skin7"
                  />
                </div>
                <h1>
            ...
            <div className={`${styles.home_img} home_img sm:flex-[none] md:flex-[1_0_0%] `}>
              <Image
                height={949}
                width={600}
                src={`${process.env.NEXT_PUBLIC_CONTENT_IMAGE_URL}img/${brand.attributes.template}/home_img7.png`}
        ...
        <div className="container">
          <div className={`${styles.movierow} movierow`}>
            {specialCategories.data.map((special_category: SpecialCategory) => {
              if (special_category.attributes.name === "Timeless Picks") {
                return (
                  <>
      ...
      >
        <div className="container"> 
            <div className="text-center p-10 border-0 border-[#ffffff] rounded-3xl bg-[#000000]/[0.3] max-w-[1100px] mx-auto left-0 right-0">
              <Image
                width={988}
                height={702}
                src={`${process.env.NEXT_PUBLIC_CONTENT_IMAGE_URL}img/${brand.attributes.template}/multidevice7.png`}
                // src="/timelessvod/img/multidevice7.png"
                alt="multidevice7"
              />
