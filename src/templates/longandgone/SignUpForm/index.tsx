      ...
      >
        <div className="container">
          <div className="flex ">
            ...
            <div className="flex-[1_0_0%] order-2">
              ...
              <div className="pl-8 text-xs">{brand.attributes.membership.signupDescription}</div>
              ...
              <>
                ...
                <div className="pl-8 text-xs">{brand.attributes.fallback.signupDescription}</div>
              </>
              )}
              <br />
            ...
            <LeftImage image={"home_img5"} width={600} height={949} order-1 />
