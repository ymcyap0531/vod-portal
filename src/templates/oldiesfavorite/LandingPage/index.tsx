...
const EraLandingPageTemplate = ({
  ...
  const specialCategoriesList = ["Oldiesfavorite Gems", "Oldiesfavorite Prime"];
  return (
    <div className={styles.landing_page}>
      ...
      >
        <div className="container">
          <div className="flex ">
            ...
            <div className={`${styles.slogancontainer} slogan-container flex-[1_0_0%] sm:pt-0 md:pt-[15vh]`}>
              ...
              <div className="slogan">
                <div className={`${styles.sloganimg} sloganimg slogan-img`}>
                  <Image
                    ...
                    src="/oldiesfavorite/img/home_img4.png"
                    alt="home_img_skin"
                  />
                </div>
                <h1>
        ...
        <div className="container">
          <div className={`${styles.movierow} movierow`}>
            {specialCategories.data.map((special_category: SpecialCategory) => {
              if (special_category.attributes.name === "Oldiesfavorite Picks") {
                return (
                  <>
      ...
      >
        <div className="container"> 
            <div className="text-center p-10 border-0 border-[#ffffff] rounded-3xl bg-[#000000]/[0.8] max-w-[850px] mx-auto left-0 right-0">
              <Image
                width={456}
                height={272}
                src="/oldiesfavorite/img/home_img_skin.png"
                alt="home_img_skin"
              />
